# L'AMI Platform — Version finale 2.0.0 (Master II)

Plateforme e-commerce + support technique + IA conversationnelle  
**Next.js 16.3.4 · React 19 · Go Fiber · Python FastAPI · MongoDB · RabbitMQ · MinIO**

UTF-8 · icones SVG · pas d'emoji · prix en Ariary (MGA)

> Voir `docs/BILAN-FINAL.md` pour l'analyse complete.


Plateforme e-commerce + support technique + IA conversationnelle (RAG + Function Calling)
pour composants PC a Madagascar (Toamasina).
...
| Couche | Technologie |
|--------|-------------|
| Frontend | Next.js 16.3.4 (App Router) + React 19 + Tailwind + Zustand |
